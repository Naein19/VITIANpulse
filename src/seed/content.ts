...
const POSTS: ReadonlyArray<{
  ...
  { key: 'chief-guest', title: 'Chief guest visits VIT-AP for the annual research colloquium', cat: 'GUEST', imp: 'IMPORTANT', author: 'meera', ageHours: 5, location: 'Main Auditorium', tags: ['research', 'colloquium', 'guest'],
  ...
  { key: 'state-games', title: 'AP State University Games begin at the main ground', cat: 'SPORTS', imp: 'NORMAL', author: 'devraj', ageHours: 20, location: 'Main Ground', tags: ['sports', 'athletics', 'inter-university'], club: 'sports',
    summary: 'Athletics, football and volleyball fixtures run through the week, with the opening ceremony held on the main ground this morning.',
    paras: [
      'The inter-university games opened this morning with a march past and the lighting of the ceremonial lamp on the main ground. Eleven institutions are participating across nine disciplines.',
  ...
  { key: 'hostel-maintenance', title: 'Scheduled water maintenance in the north hostel blocks', cat: 'ALERT', imp: 'URGENT', author: 'devraj', ageHours: 3, location: "Women's Hostel Block A & B", tags: ['hostel', 'maintenance', 'water'],
    summary: 'Supply to the north blocks will be interrupted between 10:00 and 14:00 tomorrow for tank cleaning. Store water in advance.',
    paras: [
      'Water supply to the north hostel blocks will be interrupted between 10:00 and 14:00 tomorrow while the overhead tanks are cleaned and chlorinated.',
...
const EVENTS: ReadonlyArray<{
  ...
  { key: 'genai', title: 'Generative AI Systems: a hands-on build', cat: 'WORKSHOP', club: 'aiml', dayOffset: 4, startHour: 14, hours: 3, venue: 'AB-1 · Lab 204', location: 'ab1', seats: 60, taken: 47, regRequired: true, featured: true, tags: ['genai', 'python', 'hands-on'], school: 'SCOPE',
  ...
  { key: 'cc-contest', title: 'Weekly Contest #34 — Coding Club ladder', cat: 'COMPETITION', club: 'coding', dayOffset: 3, startHour: 19, hours: 2, venue: 'AB-1 · Lab 108', location: 'ab1', seats: 120, taken: 88, regRequired: true, tags: ['contest', 'dsa', 'weekly'],
  ...
  { key: 'ecell-pitch', title: 'Pitch Bootcamp — from idea to a ten-slide story', cat: 'WORKSHOP', club: 'ecell', dayOffset: 6, startHour: 16, hours: 3, venue: 'VSB Seminar Hall', location: 'ab3', seats: 80, taken: 34, regRequired: true, tags: ['startup', 'pitch', 'bootcamp'], school: 'VSB',
  ...
  { key: 'guest-lecture', title: 'Guest Lecture: designing systems that survive contact with users', cat: 'GUEST_LECTURE', club: 'ieee', dayOffset: 2, startHour: 11, hours: 2, venue: 'Main Auditorium', location: 'aud', regRequired: false, featured: true, tags: ['systems', 'guest', 'engineering'], school: 'SENSE',
  ...
  { key: 'cultural-night', title: 'Rhythms — inter-club cultural night', cat: 'CULTURAL', club: 'dance', dayOffset: 15, startHour: 18, hours: 4, venue: 'Open Air Amphitheatre', location: 'amp', regRequired: false, featured: true, tags: ['cultural', 'dance', 'music'],
    summary: 'Four dance crews, three bands and a drama short across an evening at the amphitheatre.',
  ...
  { key: 'chess-blitz', title: 'Friday Blitz Night', cat: 'SPORTS', club: 'chess', dayOffset: 4, startHour: 19, hours: 3, venue: 'Sports Complex · Indoor Hall', location: 'sports', seats: 64, taken: 41, regRequired: true, tags: ['chess', 'blitz', 'weekly'],
  ...
  { key: 'football-final', title: 'Inter-hostel football final', cat: 'SPORTS', club: 'sports', dayOffset: 7, startHour: 17, hours: 2, venue: 'Main Ground', location: 'ground', regRequired: false, tags: ['football', 'inter-hostel', 'final'],
  ...
  { key: 'ctf', title: 'Capture the Flag — beginner and open tracks', cat: 'COMPETITION', club: 'cyber', dayOffset: 18, startHour: 10, hours: 12, venue: 'AB-1 · Lab 204', location: 'ab1', seats: 100, taken: 52, regRequired: true, tags: ['ctf', 'security', 'competition'], school: 'SCOPE',
  ...
  { key: 'robotics-intro', title: 'Build lab safety induction and open house', cat: 'WORKSHOP', club: 'robotics', dayOffset: 5, startHour: 15, hours: 2, venue: 'AB-2 · Workshop', location: 'ab2', seats: 40, taken: 29, regRequired: true, tags: ['robotics', 'safety', 'induction'], school: 'SMEC',
  ...
  { key: 'mun', title: 'Model United Nations — training weekend', cat: 'COMPETITION', club: 'lit', dayOffset: 20, startHour: 9, hours: 9, venue: 'AB-3 Lecture Theatres', location: 'ab3', seats: 150, taken: 61, regRequired: true, tags: ['mun', 'debate', 'training'],
  ...
  { key: 'astro-night', title: 'Observation night — outer planets', cat: 'TECHNICAL', club: 'astro', dayOffset: 9, startHour: 21, hours: 4, venue: 'Rooftop, Academic Block 3', location: 'ab3', seats: 50, taken: 50, regRequired: true, tags: ['astronomy', 'observation', 'night'],
    summary: 'Club telescopes set up on the AB-3 rooftop. Weather dependent; a call is made at 18:00.',
  ...
  { key: 'recruitment-drive', title: 'Club recruitment fair — meet twenty student organisations', cat: 'CLUB_RECRUITMENT', dayOffset: 8, startHour: 10, hours: 6, venue: 'Food Court Plaza', location: 'food', regRequired: false, featured: true, tags: ['recruitment', 'clubs', 'fair'],
  ...
  { key: 'placement-talk', title: 'Pre-placement talk and process briefing', cat: 'PLACEMENT', dayOffset: 10, startHour: 14, hours: 2, venue: 'Main Auditorium', location: 'aud', seats: 800, taken: 612, regRequired: true, tags: ['placement', 'briefing', 'final-year'],
  ...
  { key: 'music-openmic', title: 'Open Mic Night', cat: 'CULTURAL', club: 'music', dayOffset: 11, startHour: 19, hours: 3, venue: 'Open Air Amphitheatre', location: 'amp', regRequired: false, tags: ['music', 'openmic', 'culture'],
    summary: 'Sign up on the night for a seven-minute slot. Any instrument, any language, any level.',
    paras: ['Sign-up sheet opens at the amphitheatre at 18:30 for seven-minute slots. Backline and a PA are provided.', 'Poetry and spoken word are welcome alongside music. Genuinely all levels — the crowd is kind.'] },
  { key: 'design-portfolio', title: 'Portfolio review clinic for placement season', cat: 'WORKSHOP', club: 'design', dayOffset: 13, startHour: 15, hours: 3, venue: 'Innovation Centre · Studio', location: 'incub', seats: 30, taken: 30, regRequired: true, tags: ['design', 'portfolio', 'placement'],
  ...
  { key: 'green-drive', title: 'E-waste collection drive', cat: 'TECHNICAL', club: 'green', dayOffset: 14, startHour: 10, hours: 7, venue: 'Central Block Forecourt', location: 'cb', regRequired: false, tags: ['sustainability', 'ewaste', 'drive'],
  ...
  { key: 'quiz', title: 'The General Quiz', cat: 'COMPETITION', club: 'lit', dayOffset: 16, startHour: 17, hours: 3, venue: 'AB-3 · LT-2', location: 'ab3', seats: 90, taken: 44, regRequired: true, tags: ['quiz', 'general', 'teams'],
  ...
  { key: 'drama', title: 'Improv Night — no audition, just show up', cat: 'CULTURAL', club: 'drama', dayOffset: 17, startHour: 19, hours: 2, venue: 'AB-1 · Seminar Hall', location: 'ab1', regRequired: false, tags: ['drama', 'improv', 'open'],
  ...
  { key: 'past-fest', title: 'Convergence — the annual technical festival', cat: 'TECHNICAL', dayOffset: -22, startHour: 9, hours: 30, venue: 'Campus-wide', location: 'cb', regRequired: false, tags: ['festival', 'technical', 'annual'],
  ...
  { key: 'past-workshop', title: 'Embedded systems bootcamp', cat: 'WORKSHOP', club: 'ieee', dayOffset: -14, startHour: 10, hours: 6, venue: 'AB-2 · Lab 301', location: 'ab2', seats: 45, taken: 45, regRequired: true, tags: ['embedded', 'bootcamp', 'past'],
  ...
  { key: 'past-marathon', title: 'Campus 10K run', cat: 'SPORTS', club: 'sports', dayOffset: -8, startHour: 6, hours: 4, venue: 'Main Ground', location: 'ground', regRequired: true, seats: 400, taken: 356, tags: ['running', '10k', 'past'],
